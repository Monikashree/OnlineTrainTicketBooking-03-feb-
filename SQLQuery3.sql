...
INSERT INTO User_Admin VALUES( 'Monika', 'Kamaraj', 21, 'Female', 'monika@gmail.com', 7010502110, 'moni', 'Admin')
INSERT INTO User_Admin VALUES( 'Mahes', 'Kamaraj', 26, 'Female', 'mahes@gmail.com', 9944600013, 'mahes', 'Admin')
select * from User_Admin
--Delete from User_Admin where ID = 103
-----------------------------------------------------------------------------------------------------------
...
AS
BEGIN
	INSERT INTO User_Admin(FirstName, LastName, Age, Sex, Email, MobileNo, Password, Roles) VALUES (@firstname, @lastname, @age, @sex, @email, @mobileno, @password, @role)
END

exec USER_ADMIN_Registration @firstname = 'Moni', @lastname ='K',@age = 21, @sex='Female', @email='moni@gmail.com', @mobileno = '9944600014', @password = 'moni', @role = 'Admin'
-----------------------------------------------------------------------------------------------------------
